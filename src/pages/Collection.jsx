  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        <p onClick={()=> setShowFilter(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2 '>FILTROS</p>
        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '': 'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            ...
            {/* agregue pantalones para un futuro pero por ahora estaria vacio */}
          </div>
        </div>
        {/*  Subcategorias*/}
      ...
      {/* aqui va el filtrado de productos nombre*/}
      <div className='flex-1'>
        ...
        {/*  aqui va el mapeo de productos Callejas*/}
